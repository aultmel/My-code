...
public class Blackjack {
	public static void main(String[] args) {
		...
		System.out.println("Aces count as 1 or 11, face cards count as 10, and the rest of the numbers count as face value.");
		...
		System.out.println("If you choose to \"stand\", the dealer will then take his turn and if your hand is closer to 21 than the dealer's hand, you win.");
	...
	public static void playGame(String[] playerHand, String[] dealerHand) {
		...
		while (playerBet <= 0) {
			System.out.print("Sorry, that's not a valid bet! Enter another amount: $");
			playerBet = scnr.nextDouble();
		}
		...
		if (playerSum == 21) {
			...
			while (playerChoice != 1 && playerSum < 21) {
				if (playerChoice == 2) {
					...
					System.out.print("That wasn't one of the choices! ");
				}
				if (playerSum < 21) {
					System.out.print("Would you like to stand or hit? 1 for stand, 2 for hit: ");
					playerChoice = scnr.nextInt();
		...
		System.out.format("You now have $%.2f", playerMoney);
	}
